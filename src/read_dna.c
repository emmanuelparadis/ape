/* read_dna.c       2026-04-17 */

/* Copyright 2013-2026 Emmanuel Paradis */
...
static unsigned char tab_trans_aminoacid[] = {
	...
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* 50-59 */
	0x00, 0x00, 0x00, 0x3f, 0x00, 0x41, 0x00, 0x43, 0x44, 0x45, /* 60-69 */
	0x46, 0x47, 0x48, 0x49, 0x00, 0x4b, 0x4c, 0x4d, 0x4e, 0x00, /* 70-79 */
	0x50, 0x51, 0x52, 0x53, 0x54, 0x00, 0x56, 0x57, 0x58, 0x59, /* 80-89 */
	0x5a, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x41, 0x00, 0x43,  /* 90-99 */
	0x44, 0x45, 0x46, 0x47, 0x48, 0x49, 0x00, 0x4b, 0x4c, 0x4d, /* 100-109 */
	0x4e, 0x00, 0x50, 0x51, 0x52, 0x53, 0x54, 0x00, 0x56, 0x57, /* 110-119 */
	0x58, 0x59, 0x5a, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* 120-129 */
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* 130-139 */
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* 140-149 */
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* 150-159 */
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* 160-169 */
...
SEXP rawStreamToDNAorAAbin(SEXP x, SEXP DNA, SEXP SKIPPED)
{
	int k, startOfSeq;
	long i, j, n;
	double n_skipped = 0;
	unsigned char *xr, *rseq, *buffer, tmp, tmp0, *TAB_TRANS;
	SEXP obj, nms, seq;

	PROTECT(x = coerceVector(x, RAWSXP));
	PROTECT(DNA = coerceVector(DNA, INTSXP));
	PROTECT(SKIPPED = coerceVector(SKIPPED, REALSXP));
	TAB_TRANS = INTEGER(DNA)[0] == -1 ? tab_trans : tab_trans_aminoacid;
	double N = XLENGTH(x);
	xr = RAW(x);
