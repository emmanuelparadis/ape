...
/* SEXP dist_dna_K80_short(SEXP DNASEQ) */
/* /\* with global deletion *\/ */
/* { */
/*     int n, s, i1, i2, s1, s2, target, Nd, Ns; */
/*     double *d, P, Q, a1, a2; */
/*     unsigned char *x; */
/*     SEXP res; */
...
/*     s = ncols(DNASEQ); */
/*     x = RAW(DNASEQ); */
/*     PROTECT(res =  allocVector(REALSXP, n * (n - 1) / 2)); */
/*     d = REAL(res); */
...
/* SEXP dist_dna_K80_short_pairdel(SEXP DNASEQ) */
/* { */
/*     int n, s, i1, i2, s1, s2, target, Nd, Ns, L; */
/*     double *d, P, Q, a1, a2; */
/*     unsigned char *x; */
/*     SEXP res; */
